...
- [ ] Task 3 core and read-only next-batch runtime collection are partially implemented; full multistage projection and HTTP/native route integration remain open. Tasks 4–6 remain open.
