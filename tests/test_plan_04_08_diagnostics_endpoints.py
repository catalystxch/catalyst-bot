...
def _make_bot():
    ...
    bot.get_state.return_value = {
        "diagnostics": {"enabled": True, "recent_actions": []}
    }
    ...
    bot.dexie_manager.get_stats.return_value = {
        ...
        "queue_size": 0,
        "tracked_mappings": 0,
        "fingerprints_cached": 0,
        "session_posted": 0,
        "session_failed": 0,
        "session_skipped": 0,
        "known_mappings": 0,
        "hydrated_from_db": False,
    }
...
class TestDiagnosticsApiStats(_FlaskBase):
    ...
    def test_spacescan_includes_token_context_cache_age(self):
        with (
            ...
            patch(
                "database.get_market_analysis_cache", return_value={"has_data": True}
            ),
        ...
        self.assertEqual(
            body["spacescan"].get("calls_by_endpoint"), {"/stats/price": 1}
        )
